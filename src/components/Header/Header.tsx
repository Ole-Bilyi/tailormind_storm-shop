                    ...
                    <Typography component='div' sx={{margin: '0 auto'}} className={`${styles.inner} ${resStyles('container', resolution)}`}>
                        ...
                        <Typography noWrap component='nav' className={`${resStyles('header_nav', resolution)}`}>
                            <Toolbar className={resStyles("nav_block", resolution)}>
                                <Link to="/signup"><PinkButton sx={buttonStyles} startIcon={<CreateRoundedIcon style={{ marginRight: '4px' }} />}>Create Account</PinkButton></Link>
                                <Link to="/login"><BlueButton sx={buttonStyles} startIcon={<LoginRoundedIcon style={{ marginRight: '4px' }} />}>Login Account</BlueButton></Link>
                            </Toolbar>
